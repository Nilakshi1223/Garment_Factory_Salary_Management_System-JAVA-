 ...
 * @author Nilakshi
 */
public class UPDATE_EMPLOYEE_DETAILS extends javax.swing.JFrame implements Runnable{
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Production Manager", "Quality Control Inspector", "Pattern Maker", "Machine Operator", "Cutting Master", "Trimmer", "Ironing Staff", "Packers", "Maintenance Technician", "Storekeeper", "Helper", "Design Assistant" }));
        ...
        jTextField7.setText("Search Using NIC");
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            ...
                                            .addComponent(jTextField8, javax.swing.GroupLayout.DEFAULT_SIZE, 552, Short.MAX_VALUE)))))
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            String jobPosition = jComboBox1.getSelectedItem().toString();
            ...
            if(empID.isEmpty() || fullName.isEmpty() || NIC.isEmpty() || contactNo.isEmpty() || email.isEmpty() || jobPosition.isEmpty() || bankAccount.isEmpty() ||guardContNo.isEmpty()){
               ...
               database.iud("UPDATE employee SET full_name='"+fullName+"', nic = '"+NIC+"', contact_no='"+contactNo+"', email='"+email+"',  job_position='"+jobPosition+"', bank_account_no='"+bankAccount+"', guardians_contact_no='"+guardContNo+"' WHERE nic = '"+searchEmployee+"'" ) ;
    ...
    private void jTextField3KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField3KeyReleased
        ...
        if (!name.matches("[a-zA-Z\\s]+")) {
            ...
            jTextField3.setText(name.replaceAll("[^a-zA-Z\\s]", "")); // Remove invalid characters
    ...
    private void jTextField6KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField6KeyReleased
        ...
        if (!email.isEmpty() && !email.matches(email)) {
            ...
            jTextField6.setText(email.replaceAll("[^\\w-\\.@]", "")); // Remove invalid characters
    ...
    private void jTextField8KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField8KeyReleased
        ...
        if (!acc.matches("\\d+")) {
            ...
            JOptionPane.showMessageDialog(this, "Bank account number should contain only numbers.", "Error", JOptionPane.ERROR_MESSAGE);
            jTextField8.setText(acc.replaceAll("[^\\d]", "")); // Remove non-numeric characters
    ...
    private void jTextField9KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField9KeyReleased
        // TODO add your handling code here:
        // TODO add your handling code here:
        String guardcont = jTextField9.getText();

        // Check for invalid characters (only alphabets and spaces allowed)
        if (!guardcont.matches("[0-9 - \\s]+")) {
            JOptionPane.showMessageDialog(this, "Invalid characters in contact.", "Error", JOptionPane.ERROR_MESSAGE);
            jTextField9.setText(guardcont.replaceAll("[0-9\\s]", "")); // Remove invalid characters
