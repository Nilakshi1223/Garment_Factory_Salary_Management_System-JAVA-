 ...
 * @author Nilakshi
 */
public class ADD_EMPLOYEE_DETAILS extends javax.swing.JFrame implements Runnable{
                                            ...
                                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                ...
                                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                                    ...
                                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                                        ...
                                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                            .addComponent(jTextField9, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 552, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            if(empID.isEmpty() || fullName.isEmpty() || NIC.isEmpty() || contactNo.isEmpty() || email.isEmpty() || jobPosition.isEmpty() || bankAccount.isEmpty() ||guardContNo.isEmpty()){
               ...
               database.iud("INSERT INTO employee (`id`,`full_name`, `nic`, `contact_no`, `email`,  `job_position`, `bank_account_no`, `guardians_contact_no`) "
                + "VALUES ('"+empID+"','"+fullName+"','"+NIC+"','"+contactNo+"','"+email+"','"+jobPosition+"','"+bankAccount+"','"+guardContNo+"')");
    ...
    private void jTextField2KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField2KeyReleased
        ...
        if (!id.matches("[0-9 - \\s]+")) {
            ...
            jTextField2.setText(id.replaceAll("[0-9\\s]", "")); // Remove invalid characters
